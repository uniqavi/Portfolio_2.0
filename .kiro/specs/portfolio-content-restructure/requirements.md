...
7. THE System SHALL limit each research row's text block to exactly three text elements: a research name of at most 40 characters, one descriptor line of at most 60 characters, and one body paragraph of at most 260 characters, with no additional body copy, list, date, or author text.
